...
<Image
  src="/images/contents/posts/type-safe-env/process-env.png"
  alt="타임존 타입만 존재하는 process.env"
/>

위와 같이, .env 파일에 API_URL을 정의해놓았더라도 정작 process.env에는 TZ(타임존)만 존재하는 것처럼 보입니다.

<Image
  src="/images/contents/posts/type-safe-env/process-env-2.png"
  alt="API_URL의 타입이 string과 undefined로 잡힘"
/>
...
<Image
  src="/images/contents/posts/type-safe-env/extend-type.png"
  alt="Node.js가 기존에 선언해놓은 ProcessEnv 타입"
/>
