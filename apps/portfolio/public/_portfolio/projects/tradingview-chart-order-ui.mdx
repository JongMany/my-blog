...
![limit.gif](/_portfolio/assets/limit-order-panel__1758336107-3112b1f.gif)

차트 내 지정가 주문 UI 추가

![market long 설정.gif](/_portfolio/assets/market-order-panel__1758336107-3112b1f.gif)
...
- **Frontend**: React, TypeScript, Lit Web Components
- **Build Tool**: Vite
- **Chart Library**: TradingView
- **Architecture**: EventBus Pattern, Layered Architecture
