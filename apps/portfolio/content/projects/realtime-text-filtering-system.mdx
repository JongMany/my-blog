...
date: 2025-01-15
cover: /projects/thumbnails/images/screenshot_2025-08-10_3.52.39.png
coverAlt: "실시간 텍스트 검열 시스템"
coverCaption: "Aho-Corasick 알고리즘을 활용한 고성능 실시간 텍스트 검열"
coverType: image
...
- **Algorithm**: Aho-Corasick Algorithm, Multi-pattern Matching
- **Performance**: Trie Data Structure, State Machine, Memory Optimization
- **Real-time**: React Hooks, Debouncing, Background Processing
- **User Experience**: Visual Feedback, Alternative Suggestions, Smooth Animations
- **Content Moderation**: Multi-level Filtering, Exception Handling, Context Awareness
- **Architecture**: Modular Design, Configurable Rules, Extensible System
