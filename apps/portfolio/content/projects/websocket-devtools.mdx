...
project: Coinness
tags: [WebSocket, DevTools, Debugging, Real-time, Monitoring, React, TypeScript]
date: 2025-01-15
cover: /projects/thumbnails/gifs/devtools.gif
coverAlt: "WebSocket 개발자 도구 데모"
coverCaption: "실시간 WebSocket 메시지 모니터링 및 디버깅 도구"
coverType: gif
