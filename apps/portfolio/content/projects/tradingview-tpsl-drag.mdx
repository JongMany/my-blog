...
project: Coinness
order: 8.0
tags: [Coinness, 기획, 리버스 엔지니어링, TradingView, Web Components]
date: 2025-01-15
cover: /projects/thumbnails/gifs/tpsl.gif
coverAlt: "TP/SL 드래그 설정 데모"
coverCaption: "차트에서 직접 TP/SL 라인을 드래그하여 설정하는 모습"
coverType: gif
...
![TP/SL 드래그 데모](/projects/thumbnails/gifs/tpsl.gif)
